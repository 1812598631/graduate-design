	  ...
	  unsigned long sensor_timestamp;
		...
		long quat[4];
				...
				{    
					 ...
					 q2=quat[2] / q30;
					 q3=quat[3] / q30;
					 Angle_Balance_X = asin(-2 * q1 * q3 + 2 * q0* q2)* 57.3; 	
					 Angle_Balance_Y = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3; // roll		 
					 Angle_Balance_Z = 	atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3;
					 Gyro_Balance_Y=gyro[0];              //更新平衡角速度
					 Gyro_Balance_X=gyro[1];              //更新平衡角速度
					 Gyro_Balance_Z=gyro[2];
				}
